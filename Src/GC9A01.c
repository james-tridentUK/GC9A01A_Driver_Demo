...
#define ON                  1
#define OFF                 0
#define RESET_ON            GPIO_WritePin(LCD_RST_Port, LCD_RST_Pin, GPIO_HIGH)
#define RESET_OFF           GPIO_WritePin(LCD_RST_Port, LCD_RST_Pin, GPIO_LOW)
#define DC_ON               GPIO_WritePin(LCD_DC_Port, LCD_DC_Pin, GPIO_HIGH)
#define DC_OFF              GPIO_WritePin(LCD_DC_Port, LCD_DC_Pin, GPIO_LOW)
#define CS_ON               GPIO_WritePin(SPI1_CS_Port, SPI1_CS_Pin, GPIO_HIGH)
